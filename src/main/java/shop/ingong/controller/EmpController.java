...
public class EmpController {
    ...
    public String modForm(EmpVO vo, Model model) {
        EmpVO result = daoEmp.select(vo);
        model.addAttribute("vo", result);
    ...
    public String modAct(EmpVO vo, Model model) {
    ...
    public String delAct(EmpVO vo, Model model) {
    ...
    public String addAct(EmpVO vo, Model model) {
